          ...
          >
            {parsed ? (
              <>
                ...
                {showPdfButton && (
                  <div className="flex flex-wrap items-center gap-2 pt-4 pb-2 print:hidden relative z-10">
                    <button
                      type="button"
                      onClick={() => triggerPrint(reportPrintRef.current)}
                      className="px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-500 text-white text-sm font-medium transition-colors shadow-lg shrink-0"
                    >
                      Descargar PDF
                    </button>
                  </div>
